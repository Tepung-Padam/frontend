...
export function ProfilePage() {
  ...
  if (!isCorporate) return <div className="space-y-6 pt-3"><div><p className="text-xs font-bold uppercase tracking-[0.18em] text-orange-600">Profil</p><h1 className="mt-2 font-display text-3xl font-bold">Akses demo</h1></div><Card className="max-w-xl p-6"><ProfileData user={user} /></Card></div>;
