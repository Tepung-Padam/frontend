...
export function ConsumerHomePage() {
  ...
  return <div className="space-y-5">
    ...
    <Link to="/app/bookings" className="flex items-center gap-3 rounded-2xl bg-[#e7ebff] p-4"><span className="grid h-10 w-10 place-items-center rounded-full bg-[#087c5b] text-white"><Building2 size={20} /></span><div className="min-w-0 flex-1"><p className="font-bold">Layanan cabang dan booking</p><p className="text-xs text-[#626a78]">Cari cabang dan kelola jadwal kunjungan</p></div><ArrowRight size={19} className="text-[#4f5867]" /></Link>
  </div>;
}
